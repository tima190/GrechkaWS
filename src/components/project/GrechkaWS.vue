...
<div
                        class="relative group overflow-hidden p-8 rounded-xl bg-white border border-gray-200 dark:border-indigo-800 dark:bg-gray-900">
                        ...
                        <div class="relative">
                            <div
                                ...
                                <img src="https://raw.githubusercontent.com/tima190/GrechkaWS/97b0ab848c5cc3e53422a3121368461dacee4965/src/assets/logo2.svg" alt="Noise">
                            </div>

                            <div class="mt-6 pb-6 rounded-b-[--card-border-radius]">
                                <p class="text-gray-700 dark:text-gray-300">GrechkaWS - личный сайт</p>
                                <p class="text-gray-700 dark:text-gray-300">Создан в личных целях на vue и tailwindcss</p>
                            </div>

                            <div class="flex gap-3 -mb-8 py-4 border-t border-gray-200 dark:border-gray-800">
                                <a href="https://github.com/tima190/GrechkaWS/archive/refs/heads/main.zip" download="/"
                                ...
                                <a href="https://github.com/tima190/GrechkaWS"
